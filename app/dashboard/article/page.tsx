...
function page() {
  return (
    ...
    <Box className="flex flex-col md:flex-row items-center justify-evenly gap-4 w-full">
       ...
       <Box onClick={
        ()=>{
          window.location.href = "article/viewpost"
        }
       }  title="View all created Posts" className="bg-[#6486ff] text-white min-w-[150px] w-full h-full min-h-[150px] flex items-center justify-center flex-col border  rounded-[15px] cursor-pointer hover:scale-110">
       <GridViewIcon/>
