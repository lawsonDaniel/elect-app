  ...
  const [allArticle,setArticle] = useState([])
    ...
    return (
      <Box>
        ...
        <Box className="h-[70vh] md:h-[100vh] w-full relative overflow-x-hidden">
        <div style={{
        ...
        <img className="h-[70vh] md:h-[100vh] w-full object-cover" src="img1.jpeg" alt="Image 1" />
        </Box>
        <Box className="h-[70vh] md:h-[100vh] w-full relative">
        <div style={{
          background:"linear-gradient(0deg, black, #08263dad)"
        }} className="absolute inset-0 flex flex-col items-center justify-center ">
            <Typography style={{
        ...
        <img className="h-[70vh] md:h-[100vh] w-full object-cover" src="img2.jpeg" alt="Image 1" />
        </Box>
          <Box className="h-[70vh] md:h-[100vh] w-full relative">
        <div style={{
          background:"linear-gradient(0deg, black, #08263dad)"
